...
//  MyPokemon
//
//  Created by Amos Ebenhaezer on 26/11/22.
//
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        //root viewcontroller
//        setupRootController(vc: HomeViewController(), animationOptions: nil)
        setupRootController(vc: DetailViewController(), animationOptions: nil)
    }
